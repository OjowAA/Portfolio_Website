// Particle animation by cruip.com
class ParticleAnimation {
  constructor(el, { quantity = 100, staticity = 30, ease = 5 } = {}) {
    this.canvas = el;
  ...
  circleParams() {
    ...
    const alpha = 0;
    const targetAlpha = parseFloat((1/size*1.3).toFixed(1));
    const dx = (Math.random() - 0.5) * 0.2;
    const dy = (Math.random() - 0.5) * 0.2;
    const magnetism = 6/size*0.8;
